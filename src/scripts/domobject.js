...
const domObject = {
    ...
    messageComponent(messageObject) {
        ...
        stronclas"messagesList__Item__User" href="#friendsRequestAlert">${messageObject.userID.name}</a></strong>--${messageObject.message}</p>
        </span>
        <span class="messageButton">
        <button type="button" id="editMessage--${id} class="dashboardButton">
        </span>
        </section>`
    },
